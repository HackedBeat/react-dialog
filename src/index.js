...
class Dialog extends React.Component {
  ...
  render() {
    ...
    let dialog = (
      <div
        style={{ height, width, transform: `translate(${x}px, ${y}px)` }}
        className={cs('ui-dialog', { minimized: isMinimized, maximized: isMaximized })}
      >
        {this.getDialogTitle()}
        {
        ...
        {
          !isMinimized && <DialogFooter buttons={buttons} onClose={this.onClose} />
        }
